...
// const urlBackSongList = 'https://painassasin.online/catalog/track/all/';
// const song = [{}];

// function req() {
//   axios.get(urlBackSongList).then(dataBack => {song.push(dataBack)}) // запрос на бэк
// }

export default function TrackList() {
//   req()
//   console.log(song.data[1].author);
